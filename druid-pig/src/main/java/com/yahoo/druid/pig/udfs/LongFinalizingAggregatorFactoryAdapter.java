...
public class LongFinalizingAggregatorFactoryAdapter extends AggregatorFactoryAdapter<Long>
{
  public LongFinalizingAggregatorFactoryAdapter(String aggFactorySpec, String metricType)
  {
