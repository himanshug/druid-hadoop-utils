...
public class DoubleFinalizingComplexMetricAgg  extends ComplexMetricAgg<Double>
{
  public DoubleFinalizingComplexMetricAgg(String aggFactorySpec, String metricType)
  {
