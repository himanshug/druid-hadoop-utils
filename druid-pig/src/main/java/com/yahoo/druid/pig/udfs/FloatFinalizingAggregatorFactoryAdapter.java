...
public class FloatFinalizingAggregatorFactoryAdapter extends AggregatorFactoryAdapter<Float>
{
  public FloatFinalizingAggregatorFactoryAdapter(String aggFactorySpec, String metricType)
  {
